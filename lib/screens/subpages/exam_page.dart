...
import 'exam_completed_succes.dart';

class ExamPage extends StatefulWidget {
  final String subject;

  const ExamPage({Key key, this.subject}) : super(key: key);

  @override
  _CartPageState createState() => _CartPageState();
}

class _CartPageState extends State<ExamPage> {
                        ...
                        onTap: () {
                         ...
                         if(count==question.length){
                           Navigator.push(context, MaterialPageRoute(builder: (context) {
                             return ExamSuccessPage( subject: "",);
                           }));
                         }
                        },
                        child: Container(
